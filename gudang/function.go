...
func init() {
	functions.HTTP("warehouse", warehouse_gudang)
}

func warehouse_gudang(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, module.GCFHandlerGetAllProducts("MONGOSTRING", "warehouse_db"))
}